...
from surface_model_tracking import ParcelsConfig as ParcelsModelConfig
from surface_model_tracking import execute_backward_release, write_metadata
...
if __name__ == "__main__":
    ...
    config = ParcelsModelConfig(
        ...
        d_lat_release=0.1,
        model_dir=Path("/mnt/d/surf/"),
        output_dir=Path("/mnt/d/nccs-transport/tracks/model/test/surface/"),
